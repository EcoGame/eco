...
public class RenderUtil {
    ...
    private static void loadResources() {
        ...
        Render.treeTexture.addTexture(new eco.game.Point(2, 1));
        Render.treeTexture.addTexture(new eco.game.Point(5, 4));

        Render.smallHouseTexture.addTexture(new eco.game.Point(0, 1));
        Render.smallHouseTexture.addTexture(new eco.game.Point(1, 6));
        Render.smallHouseTexture.addTexture(new eco.game.Point(4, 6));
        Render.smallHouseTexture.addTexture(new eco.game.Point(5, 6));
        Render.smallHouseTexture.addTexture(new eco.game.Point(6, 6));
        Render.smallHouseTexture.addTexture(new eco.game.Point(7, 6));
        Render.smallHouseTexture.addTexture(new eco.game.Point(1, 7));
        Render.smallHouseTexture.addTexture(new eco.game.Point(4, 7));
        Render.smallHouseTexture.addTexture(new eco.game.Point(5, 7));
        Render.smallHouseTexture.addTexture(new eco.game.Point(6, 7));
        Render.smallHouseTexture.addTexture(new eco.game.Point(7, 7));

        Render.bigHouseTexture.addTexture(new eco.game.Point(3, 1));
        Render.bigHouseTexture.addTexture(new eco.game.Point(4, 3));
        Render.bigHouseTexture.addTexture(new eco.game.Point(5, 3));
        Render.bigHouseTexture.addTexture(new eco.game.Point(2, 5));
        Render.bigHouseTexture.addTexture(new eco.game.Point(3, 5));
        Render.bigHouseTexture.addTexture(new eco.game.Point(0, 6));
        Render.bigHouseTexture.addTexture(new eco.game.Point(2, 6));
        Render.bigHouseTexture.addTexture(new eco.game.Point(3, 6));
        Render.bigHouseTexture.addTexture(new eco.game.Point(0, 7));
        Render.bigHouseTexture.addTexture(new eco.game.Point(2, 7));
        Render.bigHouseTexture.addTexture(new eco.game.Point(3, 7));

        Render.smallCastleTexture.addTexture(new eco.game.Point(1, 1));
        Render.smallCastleTexture.addTexture(new eco.game.Point(4, 4));

        Render.bigCastleTexture.addTexture(new eco.game.Point(1, 3));
        Render.bigCastleTexture.addTexture(new eco.game.Point(3, 4));
